...
ELSEIF(CMAKE_SYSTEM_NAME MATCHES "Darwin")
   ...
   STRING(COMPARE EQUAL "AVX1.0" "${SSE_THERE}" AVX_TRUE)
   IF (AVX_TRUE)
      set(AVX_FOUND true CACHE BOOL "AVX available on host")
   ELSE (AVX_TRUE)
      set(AVX_FOUND false CACHE BOOL "AVX available on host")
   ...
   STRING(REGEX REPLACE "^.*(AVX2.0).*$" "\\1" SSE_THERE ${CPUINFO})
   STRING(COMPARE EQUAL "AVX2.0" "${SSE_THERE}" AVX2_TRUE)
   IF (AVX2_TRUE)
      set(AVX2_FOUND true CACHE BOOL "AVX2 available on host")
   ELSE (AVX2_TRUE)
      set(AVX2_FOUND false CACHE BOOL "AVX2 available on host")
...
if(NOT AVX2_FOUND)
      MESSAGE(STATUS "Could not find support for AVX2 on this machine.")
