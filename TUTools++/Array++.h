 ...
 */
/*
 *  $Id: Array++.h,v 1.14 2007-03-06 07:15:30 ueshiba Exp $
 */
...
{
  public:
    typedef typename Buf<T>::value_type		value_type;	//!< 要素の型
...
*/
template <class T, class B> inline
Array2<T, B>::operator const_pointer() const
{
