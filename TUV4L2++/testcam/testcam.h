...
enum
{
  ...
  // Camera feasures.
    ...
    c_Gain_Auto			= V4L2Camera::GAIN_AUTO,
    ...
    c_Black_Level		= V4L2Camera::BLACK_LEVEL,
    c_White_Balance_Temperature	= V4L2Camera::WHITE_BALANCE_TEMPERATURE,
    c_White_Balance_Auto	= V4L2Camera::WHITE_BALANCE_AUTO,
    c_Red_Balance		= V4L2Camera::RED_BALANCE,
    c_Blue_Balance		= V4L2Camera::BLUE_BALANCE,
    c_HFlip			= V4L2Camera::HFLIP,
    c_VFlip			= V4L2Camera::VFLIP,
