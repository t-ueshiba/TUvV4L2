...
{
    {IIDCCamera::MONO_8,		"Y(mono)",		0},
    {IIDCCamera::YUV_411,		"YUV(4:1:1)",		0},
    {IIDCCamera::YUV_422,		"YUV(4:2:2)",		0},
    {IIDCCamera::YUV_444,		"YUV(4:4:4)",		0},
    {IIDCCamera::RGB_24,		"RGB",			0},
    {IIDCCamera::MONO_16,		"Y(mono16)",		0},
    {IIDCCamera::RGB_48,		"RGB(color48)",		0},
    {IIDCCamera::SIGNED_MONO_16,	"Y(signed mono16)",	0},
    {IIDCCamera::SIGNED_RGB_48,		"RGB(signed color48)",	0},
    {IIDCCamera::RAW_8,			"RAW(raw8)",		0},
    {IIDCCamera::RAW_16,		"RAW(raw16)",		0}
};
